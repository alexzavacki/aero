 ...
 *
 * Converts exceptions to pretty-formatted output
 *
 * @category    Aero
...
class ExceptionHandler
{
     ...
     *
     * @param  bool $debug
     * @return \Aero\Application\Debug\ExceptionHandler
     */
    ...
    public function createResponse($exception)
    {
        ...
        try {
            ...
            if ($this->debug) {
                ...
                $content = '<h2 style="color:#d30">' . $exception->getMessage() . '</h2><br/><br/>'
        ...
        return new Response($this->decorate($content, $title), 500);
    }
